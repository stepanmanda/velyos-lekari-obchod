  ...
  return (
    <div className="page">
      ...
      <section className="filters" aria-label="Filtry kontaktů">
        ...
        <label><span>Obor</span><select value={specialty} onChange={(event) => setSpecialty(event.target.value as Specialty | "Vše")}><option>Vše</option><option>Praktik</option><option>Pediatrie</option><option>Gynekologie</option><option>Stomatologie</option><option>ORL</option><option>Dermatologie</option><option>Oční</option><option>Kardiologie</option><option>Ortopedie</option></select></label>
  ...
  return (
    <div className="page content-page">
      ...
      <section className="manual-section">
        ...
        <div className="segment-tabs">{(["Praktik", "Pediatrie", "Gynekologie", "Stomatologie", "ORL", "Dermatologie", "Oční", "Kardiologie", "Ortopedie"] as Specialty[]).map((value) => <button className={activeSpecialty === value ? "active" : ""} onClick={() => setActiveSpecialty(value)} key={value}>{value}</button>)}</div>
